...
import { Sparkles, TrendingUp, ChevronRight, Layers, MapPin, Compass, Flame, ShieldCheck } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-start">
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="space-y-2 flex-1">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white border border-gray-200/80 text-[11px] font-extrabold text-gray-700 shadow-xs">
                <Sparkles className="w-3 h-3 text-[#FF2E93]" />
                <span>Hi, Alex 👋</span>
              </div>

              <h1 className="text-3xl lg:text-4xl font-black text-gray-950 tracking-tight leading-tight">
                Ready to slay your{' '}
                <span className="highlight-circle font-black text-black">vibe</span>{' '}
                today?
              </h1>

              <p className="text-xs lg:text-sm text-gray-500 font-medium leading-relaxed">
                Multimodal AI Stylist &amp; Weather-Grounded Experience Map.
              </p>
            </div>

            {/* Free-Floating 3D Lumi Mascot */}
            <div className="relative w-28 h-28 lg:w-36 lg:h-36 shrink-0 animate-lumi-float">
              ...
              {contexts.map((ctx) => {
                ...
                return (
                  <button
                    ...
                    className={`snap-start shrink-0 px-4 py-2.5 rounded-2xl flex items-center gap-2 transition-all duration-300 ${
                      isSelected
          ...
          <div className="p-3.5 bg-white rounded-2xl border border-gray-200/70 shadow-xs flex items-center justify-between gap-2">
          ...
          <button
            ...
            className="w-full py-4 px-5 rounded-full bg-[#0F172A] hover:bg-black text-white font-extrabold text-sm lg:text-base shadow-xl active:scale-98 transition-all flex items-center justify-between group cursor-pointer"
          >
        ...
        <div className="lg:col-span-6 space-y-4">
          <div className="flex items-center justify-between px-1">
            ...
            <span className="text-[10px] font-extrabold text-emerald-600 flex items-center gap-1 bg-emerald-50 px-2.5 py-0.5 rounded-full border border-emerald-200">
              <TrendingUp className="w-3 h-3" /> Live Knowledge Graph
            </span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3.5">
            {/* Metric 1: Aura Index */}
            <div className="calm-card-elevated p-4 lg:p-5 rounded-3xl space-y-1.5 relative overflow-hidden">
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-2xl lg:text-3xl font-black text-gray-950 tracking-tight">92.4</span>
            ...
            <div className="calm-card-elevated p-4 lg:p-5 rounded-3xl space-y-1.5 relative overflow-hidden">
              ...
              <div className="text-xl lg:text-2xl font-black text-gray-950 tracking-tight truncate pt-0.5">
                Cyber-Pop
              </div>
            ...
            <div className="calm-card-elevated p-4 lg:p-5 rounded-3xl space-y-1.5 relative overflow-hidden">
              ...
              <div className="flex items-baseline gap-1.5">
                <span className="text-2xl lg:text-3xl font-black text-gray-950 tracking-tight">15</span>
                <span className="text-[10px] font-semibold text-gray-400">HCMC Spots</span>
              </div>
            ...
            <div className="calm-card-elevated p-4 lg:p-5 rounded-3xl space-y-1.5 relative overflow-hidden">
              ...
              <div className="flex items-baseline gap-1.5">
                <span className="text-2xl lg:text-3xl font-black text-gray-950 tracking-tight">20</span>
          ...
          <div className="p-4 lg:p-5 rounded-3xl bg-gradient-to-r from-purple-900 via-gray-950 to-black text-white shadow-xl flex items-center justify-between gap-4">
            <div className="space-y-1">
              <span className="text-[10px] font-black uppercase text-[#D4FF00] tracking-wider flex items-center gap-1">
                <ShieldCheck className="w-3.5 h-3.5" /> Deterministic AI Grounding
              </span>
              <h4 className="text-sm font-extrabold">
                Never get sent to a closed cafe or open rooftop in rain.
              </h4>
              <p className="text-[11px] text-gray-400">
                Gemini Multimodal reasoning tied with real-world weather and venue open hours.
              </p>
            </div>
            <div className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center shrink-0">
              <Flame className="w-6 h-6 text-[#FF2E93]" />
            </div>
          </div>
        </div>
